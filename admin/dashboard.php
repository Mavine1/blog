    ...
    <div class="container dashboard_container">
        ...
        <aside>
          <ul>
            ...
            <li>
                <a href="dashboard.html" class="active"><i class="fa-solid fa-address-card"></i><h5>Manage Posts</h5></a>
            </li>
            <li>
            ...
            <li>
                <a href="manage-categories.html" ><i class="fa-solid fa-list"></i><h5>Manage categories</h5></a>
            </li>
          </ul>
        </aside>
        <main>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque.</td>
                    <td>Wild Life</td>
